...
Foam::CCMchemistryReductionMethod<ThermoType>::CCMchemistryReductionMethod
(
    Foam::CCMchemistryModel<ThermoType>& chemistry
)
:
    coeffsDict_(),
...
template<class ThermoType>
void Foam::CCMchemistryReductionMethod<ThermoType>::initReduceMechanism()
{
    if (log_)
    {
...
template<class ThermoType>
void Foam::CCMchemistryReductionMethod<ThermoType>::endReduceMechanism
(
    List<label>& ctos,
...
template<class ThermoType>
void Foam::CCMchemistryReductionMethod<ThermoType>::update()
{
    if (log_)
    {
        cpuReduceFile_()
